...
function shiftContainer(area) {
    const container = document.getElementById("container");
    if (area == true) {
        if (!container.classList.contains("shift-up")) {
            // If not shifted, add the class
            container.classList.add("shift-up");
        }
    } else {
        if (container.classList.contains("shift-up")) {
            // If the container is already shifted up, remove the class
